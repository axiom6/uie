...
(function() {
  ...
  Wheel = (function(superClass) {
    extend(Wheel, superClass);

    module.exports = Wheel;

    function Wheel(g1, width, height) {
      var dr;
      this.g = g1;
      if (width == null) {
        width = 1200;
    ...
    Wheel.prototype.hueQuads = function(inc) {
      var a, hue, i, ref;
      a = [];
      for (hue = i = 0, ref = inc; i < 360; hue = i += ref) {
        a.push({
    ...
    Wheel.prototype.hueWedges = function(dh, dr, r1, r2) {
      ...
      for (hue = i = 0, ref = dh; i < 360; hue = i += ref) {
        for (r = j = ref1 = r1, ref2 = r2, ref3 = dr; ref3 > 0 ? j < ref2 : j > ref2; r = j += ref3) {
