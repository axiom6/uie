...
class Link
  ...
  module.exports = Link # Util.Export( Link, 'd3d/Link' )
  ...
  link2:( x1, y1, x2, y2, n, fill ) ->
    ...
    b2 = a2 - @da * n2
    e2 = a2 + @da * n2 + 1
    #Util.log( 'Link.link', { r:Util.toFixed(r), a1:Util.toFixed(a1), a2:Util.toFixed(a2), n:n, n2:n2, b1:b1, e1:e1, b2:b2, e2:e2 } )
  ...
  tree:( g, x0, y0, pts, stroke ) ->
    for [x,yy] in pts
      ...
      #Util.log( { x0:x0, y0:y0, x1:x1, y1:y1, x2:x2, y2:y2, x3:x, y3:yy } )
    return
